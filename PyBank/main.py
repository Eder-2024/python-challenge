...
First_value=int(changes[0])#Query the first value in changes list to be remove from the accumulate changes       
average_changes = (accumulate_change-First_value)/(len(changes)-1)
